...
Total public PRs merged: **206**

---

## [PCSX2/myMCpp](https://github.com/PCSX2/myMCpp)
- [Qt: Switch config to INI and make renderers optional

](https://github.com/PCSX2/myMCpp/pull/110) _(merged 2026-09-25)_
- [Qt: Move icon rendering to QWindow](https://github.com/PCSX2/myMCpp/pull/109) _(merged 2026-09-25)_
- [Resources: Update version metadata and macOS file associations](https://github.com/PCSX2/myMCpp/pull/107) _(merged 2026-09-22)_
- [CI/Build: Use git tags for versioning and add stable release workflow](https://github.com/PCSX2/myMCpp/pull/104) _(merged 2026-09-14)_
- [Formats: Match repo code style and naming](https://github.com/PCSX2/myMCpp/pull/102) _(merged 2026-08-31)_
...
- [CI/Qt: Update to Qt 6.11.1 and add qt svg to ci/cmake](https://github.com/PCSX2/myMCpp/pull/64) _(merged 2026-06-29)_
- [Core/Renderer/VK: Finish VMA migration, validation fixes, smoother resize, and various fixes](https://github.com/PCSX2/myMCpp/pull/62) _(merged 2026-06-29)_
...
- [Qt: Allow customizing toolbar actions](https://github.com/PCSX2/pcsx2/pull/14953) _(merged 2026-09-18)_
...
- [Qt/macOS: Keep Fullscreen on the main window](https://github.com/PCSX2/pcsx2/pull/14841) _(merged 2026-08-17)_
- [GS: Fix status bar GPU % when OSD GPU usage is off](https://github.com/PCSX2/pcsx2/pull/14809) _(merged 2026-08-04)_
